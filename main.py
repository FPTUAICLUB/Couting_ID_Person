...
#        print(row)
    ...
    for bbox in bbox_id:
        ...
        if results >= 0: 
            ...
            people_tracking[len(people_entering)] = (x1, y4)
            cv2.rectangle(frame,(x1,y1),(x2,y2),(0,255,0),2)
            cv2.circle(frame, (x2, y2), 5, (255, 0, 255),-1)
            cv2.putText(frame,str(c),(x1,y1),cv2.FONT_HERSHEY_COMPLEX,(0.5),(255,255,255),1)
            for person_id, pt in people_tracking.items():
                cv2.circle(frame, pt, 5, (0,0, 255), -1)
                cv2.putText(frame, str(person_id), (pt[0], pt[1]-7), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 0, 255), 2)
